...
base=pygame.image.load("Faucon/Faucon650.png").convert_alpha()
...
position_personnage=position_personnage.move(Affiche_murs(niveau,mur))
...
while continuer ==1 : #tant que continuer est égal à 1, on recommence la boucle
    if Detecte_collision(position_personnage,niveau,objet="a") :
        if niveau !=Charge_Niveau("TP2_niv2") :
            ...
            position_personnage.x,position_personnage.y=Affiche_murs(niveau,mur)
    ...
    pygame.display.update(position_personnage) #rafraichissement de l'écran
